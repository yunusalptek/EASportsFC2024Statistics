...
We want to answer the question of how does a players overall rating compare to their market value. Intuitively, we suspect a positive correlation between these variables; however, we want to see just how strong that correlation might be. Additionally, at what rating does the price of the players start to vary. A scatterplot is the best option to answer all of these questions.
...
player_stats <- read_csv("C:/Users/Yunus/Downloads/male_players.csv") # Read csv
...
fifa_stats <- read_csv("C:/Users/Yunus/Downloads/male_players.csv") # Read csv file
